...
public class frmLoguser extends javax.swing.JFrame {
    Connection con;
    Statement stm;
    ResultSet rst,rst2;
    ...
    public frmLoguser() {
        ...
        try { 
            ...
            rst=stm.executeQuery("Select distinct date(DATE_TIME) as date__time from LOGINLOG;");
            while(rst.next()){
    ...
    private void Querry() {
        try {
            int i=stm.executeUpdate("alter table loginlog drop column s_no;");
            int j=stm.executeUpdate("alter table loginlog add column S_No int(6) not null unique auto_increment first;");
            DefaultTableModel tblmodel = (DefaultTableModel)tbluser.getModel();
            if(cmbDate.getSelectedItem().equals("Choose Date...")) {
                rst2=stm.executeQuery("select * from loginlog ;");
                ...
                rst2=stm.executeQuery("select * from loginlog where Date(DATE_TIME) ='"+cmbDate.getSelectedItem()+"';");
                tblmodel.setRowCount(0);
                while(rst2.next()) {
                    Object[] row = new Object[]{rst2.getInt(1),rst2.getString(2),new SimpleDateFormat("YYYY-MM-dd HH:mm:ss").format(rst2.getTimestamp(3))};
                    tblmodel.addRow(row);
    ...
    private void initComponents() {
        ...
        tbluser.setFont(new java.awt.Font("sansserif", 1, 14)); // NOI18N
        tbluser.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "S_NO", "Last_Login_By", "Date_Time"
            }
        ) {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(cmbDate, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void btnDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelActionPerformed
        try {
            if(cmbDate.getSelectedItem().equals("Choose Date...")) {
                JOptionPane.showMessageDialog(this,"Please Select Date First","ERROR",JOptionPane.INFORMATION_MESSAGE);
            }
            else {
                int i = stm.executeUpdate("delete from loginlog where Date(Date_Time) ='"+cmbDate.getSelectedItem()+"';");
                if(i>=1) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmLoguser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmLoguser().setVisible(true);
            }
        });
    }
